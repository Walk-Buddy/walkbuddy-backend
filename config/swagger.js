    ...
    '/api/tags': {
      get: {
        ...
        responses: {
          200: {
            description: '태그 목록',
            content: { 'application/json': { schema: { type: 'object', properties: { success: { type: 'boolean', example: true }, total: { type: 'integer', example: 26 }, course_count: { type: 'integer', example: 8 }, spot_count: { type: 'integer', example: 18 }, course_tags: { type: 'array', items: { type: 'object', properties: { tag_id: { type: 'string', format: 'uuid' }, name: { type: 'string', example: '둘레길' }, type: { type: 'string', example: 'course' } } } }, spot_tags: { type: 'array', items: { type: 'object', properties: { tag_id: { type: 'string', format: 'uuid' }, name: { type: 'string', example: '문화/예술' }, type: { type: 'string', example: 'spot' } } } } } } } },
          },
        },
      },
    },
